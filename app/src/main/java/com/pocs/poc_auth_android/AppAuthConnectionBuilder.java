...
public class AppAuthConnectionBuilder implements ConnectionBuilder {

    public static final AppAuthConnectionBuilder INSTANCE = new AppAuthConnectionBuilder();
    ...
    private AppAuthConnectionBuilder() {
